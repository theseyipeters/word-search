...
const WORD_LISTS = [
  ["REACT", "TYPESCRIPT", "VITE", "JAVASCRIPT", "PYTHON", "RUST", "GOLANG", "SWIFT", "KOTLIN", "RUBY"],
  ["GALAXY", "NEBULA", "COMET", "PLANET", "QUASAR", "ORBIT", "PULSAR", "METEOR", "NOVA", "ECLIPSE"],
  ["OCEAN", "MOUNTAIN", "FOREST", "DESERT", "CANYON", "GLACIER", "VOLCANO", "ISLAND", "RIVER", "PRAIRIE"],
  ["CIPHER", "MATRIX", "BINARY", "VECTOR", "TENSOR", "NEURAL", "QUANTUM", "KERNEL", "PIXEL", "SYNTAX"],
  ["FALCON", "EAGLE", "PHOENIX", "RAVEN", "SPARROW", "CONDOR", "HAWK", "OSPREY", "CRANE", "HERON"],
];
